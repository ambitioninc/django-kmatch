...
.. _ambitioninc repository: https://github.com/ambitioninc/django-kmatch
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/ambitioninc/django-kmatch.git
    $ cd django-kmatch
    $ virtualenv env
    $ . env/bin/activate
...
.. code-block:: python
    ...
    from django_kmatch.version import __version__
...
When in the project directory::
    ...
    $ pip uninstall -y django-kmatch && python setup.py install
    $ cd docs && make html
...
* Bump version in django_kmatch/version.py
* Git tag the version
